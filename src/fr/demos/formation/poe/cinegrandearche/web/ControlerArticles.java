...
public class ControlerArticles extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Livre l3 = new Livre("livre_demat_00002", 32.99,
				"La conduite de projet - 3e ed. - 126 règles pour piloter vos projets avec succès",
				"images/img_article_livre_mat_00001.jpg", "ePub", "URL telechargement l3", "Thierry HOUGRON",
		...
		Livre l4 = new Livre("livre_mat_00002", 39.00,
				"Android - Guide de développement d'applications Java pour Smartphones et Tablettes (3e édition)",
				"images/img_article_livre_mat_00002.jpg", 10, "Sylvain HEBUTERNE", "9782409002533", "ENI",
		...
		Livre l5 = new Livre("livre_mat_00003", 33.00,
				"Scrum - 4e éd.- Le guide pratique de la méthode agile la plus populaire",
				"images/img_article_livre_mat_00003.jpg", 10, "Claude AUBRY", "9782100738748", "DUNOD",
		...
		Livre l6 = new Livre("livre_demat_00003", 23.99,
				"Scrum - 4e éd.- Le guide pratique de la méthode agile la plus populaire",
				"images/img_article_livre_mat_00003.jpg", "Kindle", "URL telechargement l6", "Claude AUBRY",
